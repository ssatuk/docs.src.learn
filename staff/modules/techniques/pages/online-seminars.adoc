...
xref:zoom:index.adoc[Zoom] offers Breakout Rooms (i.e. sub-meetings) as a native feature. To mimic this feature in Teams a  xref:officestaff:msteams:techniques/breakout-rooms-in-teams.adoc[Breakout rooms] workaround (Team-based setup with multiple channels) would be needed.
